...
@Component({
  ...
  styleUrls: ['./normal-calculator.component.scss']
})
export class NormalCalculatorComponent implements OnInit {
  ...
  delete(){
    if(this.numberArea?.length === 1){
      ...
      this.numberArea=this.numberArea.substring(0,this.numberArea?.length-1)
    }
  }
